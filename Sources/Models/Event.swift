...
/// Persisted organizer-controlled state. `archived` is SnapLoop's MVP soft
/// delete: it hides the event from the normal Events list without destroying
/// membership, matches, invite identity, or audit history.
