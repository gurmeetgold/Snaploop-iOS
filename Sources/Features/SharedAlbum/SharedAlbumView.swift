...
struct SharedAlbumView: View {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                if model.photos.isEmpty {
                    ContentUnavailableViewCompat(
                        ...
                        message: "Matched preview thumbnails appear here as event members sync their cameras.",
    ...
    private var statsCard: some View {
        HStack(spacing: 0) {
            statTile(value: "\(model.photos.count)", label: "Matched previews", icon: "photo.stack")
